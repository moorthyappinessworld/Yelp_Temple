...
const {checkReview,isLoggedIn,isVerifyReviewAuthor} = require('../middleware');

const reviews = require('../controllers/reviews');

router.post('/',isLoggedIn,checkReview,errorAsync(reviews.addReview))

router.delete('/:reviewId',isLoggedIn,isVerifyReviewAuthor,errorAsync(reviews.deleteReview))
